...
C_SRCS += \
../lib/middleware/fft/fft.c 

OBJS += \
./lib/middleware/fft/fft.o 

C_DEPS += \
./lib/middleware/fft/fft.d 


# Each subdirectory must supply rules for building sources it contributes
lib/middleware/fft/%.o lib/middleware/fft/%.su lib/middleware/fft/%.cyclo: ../lib/middleware/fft/%.c lib/middleware/fft/subdir.mk
...
clean: clean-lib-2f-middleware-2f-fft

clean-lib-2f-middleware-2f-fft:
	-$(RM) ./lib/middleware/fft/fft.cyclo ./lib/middleware/fft/fft.d ./lib/middleware/fft/fft.o ./lib/middleware/fft/fft.su

.PHONY: clean-lib-2f-middleware-2f-fft
